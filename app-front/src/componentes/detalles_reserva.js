...
class DetallesReserva extends /*React.*/ Component{
    ...
    constructor(props){
        ...
        console.log(this.state.datos_reserva.datos_guardian.precio)
    ...
    onSubmit(evt){
        ...
        window.fetch('http://localhost:4000/api/malt/detalles_reserva/reserva', {
            ...
            body: JSON.stringify({
                ...
                "precio":this.state.datos_reserva.datos_guardian.precio
            }), 
        ...
        <div className="contenedor">
            ...
            <form onSubmit={this.onSubmit}>
                <div className="detalles_reserva">
                    ...
                    <p>Precio:</p>
                    <input type="text" value={this.state.datos_reserva.datos_guardian.precio} onChange={this.onChangePrecio} disabled/>
